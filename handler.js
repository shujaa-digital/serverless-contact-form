...
app.post("/", (req, res) => {
  ...
  const emailParams = {
    Source: "info@shujaadigital.com", // Your Verified Email
    Destination: {
      ToAddresses: ["info@shujaadigital.com"] // Your verfied Email
    },
    ...
    Message: {
      ...
      Subject: {
        Charset: "UTF-8",
        Data: "You Received a Message from www.shujaadigital.com"
      }
    }
  };
